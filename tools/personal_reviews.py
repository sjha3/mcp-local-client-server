...
from localmcpserver.server import mcp, logging
...
#create_review_tool = FunctionTool.from_function(create_review)
#update_review_tool = FunctionTool.from_function(update_review)
#delete_review_tool = FunctionTool.from_function(delete_review)